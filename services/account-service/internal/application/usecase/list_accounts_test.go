...
func TestListAccountsUseCase_Execute(t *testing.T) {
	t.Run("successfully lists accounts by tenant", func(t *testing.T) {
		...
		repo := &listMockAccountRepository{
			listByTenantFunc: func(ctx context.Context, tid uuid.UUID, limit, offset int) ([]model.CustomerAccount, int, error) {
	...
	t.Run("successfully lists accounts by holder", func(t *testing.T) {
		...
		repo := &listMockAccountRepository{
			listByHolderFunc: func(ctx context.Context, hid uuid.UUID, limit, offset int) ([]model.CustomerAccount, int, error) {
