...
// Server wraps a gRPC server for the payment service.
type Server struct {
	server  *grpc.Server
...
func NewServer(handler *PaymentHandler, port int, logger *slog.Logger, jwtService *auth.JWTService, opts ...grpc.ServerOption) *Server {
